package com.shaikhomes.watercan.custom_views;
...
public class PassCodeView extends View {
  ...
  private final ArrayList<KeyRect> keyRects = new ArrayList<>();
  ...
  private final Map<Integer, Integer> touchXMap = new HashMap<>();
  private final Map<Integer, Integer> touchYMap = new HashMap<>();
  ...
  private void setEmptyDrawable(int resId) {
    emptyDrawable = getBitmap(resId);
  }


  private void setFilledDrawable(int resId) {
